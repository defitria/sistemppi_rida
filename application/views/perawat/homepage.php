                    ...
                    <div class="card w-auto">
                        <div class="card-body text-center">
                            ...
                            ?>
                                    ...
                                    <a href="<?= base_url('perawat/seeRuangan/' . $an['ruang_rawatinap']); ?>" class="btn btn-sm btn-primary btn-block">Detail</a>
                                <?php
                                endforeach;
                            } else {
                                ?>
                    ...
                    <div class="card w-auto">
                        <div class="card-body text-center">
                            ...
                            ?>
                                    ...
                                    <a href="<?= base_url('perawat/detailPhlebitis/' . $ph['jenis_surveilans']); ?>" class="btn btn-sm btn-primary btn-block">Detail</a>
                                <?php
                                } else {
                                ?>
                    ...
                    <div class="card w-auto">
                        <div class="card-body text-center">
                            ...
                            ?>
                                    ...
                                    <a href="<?= base_url('perawat/detailScabies/' . $sc['jenis_surveilans']); ?>" class="btn btn-sm btn-primary btn-block">Detail</a>
                                <?php
                                } else {
                                ?>
                    ...
                    <div class="card w-auto">
                        <div class="card-body text-center">
                            ...
                            ?>
                                    ...
                                    <a href="<?= base_url('perawat/detailISK/' . $i['jenis_surveilans']); ?>" class="btn btn-sm btn-primary btn-block">Detail</a>
                                <?php
                                } else {
                                ?>
                    ...
                    <div class="card w-auto">
                        <div class="card-body text-center">
                            ...
                            ?>
                                    ...
                                    <a href="<?= base_url('perawat/detailDekubitus/' . $d['jenis_surveilans']); ?>" class="btn btn-sm btn-primary btn-block">Detail</a>
                                <?php
                                } else {
                                ?>
                                    <h5 class="card-title" style="font-weight: bold;">ISK</h5>
